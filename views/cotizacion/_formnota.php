...
<div class="panel">
    <div class="panel-heading">
        <h1>Convirtiendo Cotizacion Nº:<?= Html::encode($this->title) ?> en Venta</h1>
    </div>
        ...
        <div class="">
            <div class="col-md-12">
                <div class="form-group  has-success">
                    <label class="control-label" for="nota-venta-factura">Factura</label>
                    <input type="text" id="nota-venta-factura" class="form-control" name="nota-venta[factura]" maxlength="300" aria-invalid="false">
                        ...
                        <div class="item panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div style="text-align: center;" class="col-sm-2">
                                        <?= $form->field($modelAddress, "[{$i}]cantidad")->textInput(['maxlength' => true, 'onChange' => "calculador(this.id)"])->label(false) ?>
                                    </div>
                                    <div style="text-align: center;" class="col-sm-2">
    ...
    <div class="form-group">
        <?= Html::submitButton($modelAddress->isNewRecord ? 'Create' : 'Transformar Cotizacion en Venta', ['class' => 'btn btn-primary']) ?>
    </div>
